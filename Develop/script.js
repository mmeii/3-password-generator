...
function generatePassword() {
  ...
  var passLength = prompt("How many characters do you want your password to be?");
    if (passLength >= 8 && passLength <= 128) {
      ...
      var lowerCaseOption = confirm("Do you want to include a lowercase letter?");
      var upperCaseOption = confirm("Do you want to include a uppercase letter?");
      var wantNumOption = confirm("Do you want to include a number?");
      var specialCharOption = confirm("Do you want to include a special character?");      
      if (lowerCaseOption || upperCaseOption || wantNumOption || specialCharOption) {
        writePassword(); 
      } else {
